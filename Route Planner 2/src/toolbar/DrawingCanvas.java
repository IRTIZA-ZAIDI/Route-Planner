...
public class DrawingCanvas implements PortionListener {
    ...
    public static void SaveFile(){
        try {
            ...
            FileOutputStream fileOut = new FileOutputStream("src/savefiles/"+fileName);
    ...
    public void paint(Graphics graphics, ImageObserver observer){
        ...
        // Paints graph
        graph.paint(graphics, observer);

        // If shortest path is not empty , paint shortest path
        if(!IsShortestPathEmpty()) graph.paintShortestPath(graphics, observer);
